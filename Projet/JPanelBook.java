...
public class JPanelBook extends javax.swing.JPanel {
    ...
    public JPanelBook(JFrame f,String name_lib) {
     ...
     */
     ...
     private void myinitComponents(JFrame f,String name_lib) {
       ...
       jTextField4 = new javax.swing.JTextField();
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Projet/design/icons8_Contact_26px.png"))); // NOI18N
        jLabel7.setDisabledIcon(new javax.swing.ImageIcon(getClass().getResource("/Projet/design/icons8_Contact_26px.png"))); // NOI18N
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Projet/design/icons8_Moleskine_26px.png"))); // NOI18N
        jLabel13.setDisabledIcon(new javax.swing.ImageIcon(getClass().getResource("/Projet/design/icons8_Contact_26px.png"))); // NOI18N
        ...
        jLabel19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Projet/design/icons8_Collaborator_Male_26px.png"))); // NOI18N
        jLabel19.setDisabledIcon(new javax.swing.ImageIcon(getClass().getResource("/Projet/design/icons8_Contact_26px.png"))); // NOI18N
        ...
        jLabel25.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Projet/design/icons8-image-file-26.png"))); // NOI18N
        jLabel25.setText("url");
        jLabel25.setDisabledIcon(new javax.swing.ImageIcon(getClass().getResource("/Projet/design/icons8_Contact_26px.png"))); // NOI18N
        jLabel25.setIconTextGap(0);
        jLabel25.setOpaque(true);
        jPanel1.add(jLabel25);
        jLabel25.setBounds(40, 450, 30, 50);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Projet/design/icons8-add-48.png"))); // NOI18N
        jLabel1.setText("add");
        jLabel1.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jPanel1.add(jLabel1);
        jLabel1.setBounds(50, 530, 50, 48);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Projet/design/delete.png"))); // NOI18N
        jLabel2.setText("delete");
        jLabel2.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jPanel1.add(jLabel2);
        jLabel2.setBounds(200, 530, 50, 48);

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Projet/design/edit.png"))); // NOI18N
        ...
        jLabel26.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Projet/design/icons8_Unit_26px.png"))); // NOI18N
        jLabel26.setDisabledIcon(new javax.swing.ImageIcon(getClass().getResource("/Projet/design/icons8_Contact_26px.png"))); // NOI18N
        ...
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Projet/design/airy-magnifier-with-a-book-search-for-information-learning (2).png"))); // NOI18N
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Projet/design/icons8-search-50.png"))); // NOI18N
        ...
        jLabel1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
               try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/lib", "root", "love2PMandGOT7")) 
               {
                   ...
                   if(url.equals("") || url.equals(" Write Book URL")){
                       url="bookd.png";
                   }
                   ...
                   try (Statement statement = connection.createStatement()) 
                   {
                       String query1 ="select * from books where isbn="+id;
                       ...
                       if(rs1.next()){
                           ...
                           String query2 ="select * from books where auteur='"+a+"' and titre='"+name+"'";
                           ResultSet rs2 = statement.executeQuery(query2);
                           if(rs2.next()){
                               JOptionPane.showMessageDialog(null, "warning ! "+name+" with "+a+" alerady exist", "Warning", JOptionPane.WARNING_MESSAGE);
                           }
                           else{
                             String query3 = "INSERT INTO books VALUES (" + id + ", '" + name + "', '" + a + "', " + q + ", '" + url + "')";
               ...
               try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/lib", "root", "love2PMandGOT7")) 
               {
                   ...
                   try (Statement statement = connection.createStatement()) 
                   {
                       ...
                       if(rs1.next()==false){
                           ...
                           String query2 ="select * from books where isbn="+id+" and auteur='"+a+"' and titre='"+name+"'";
                           ResultSet rs2 = statement.executeQuery(query2);
                           if(rs2.next()==false){
                             ...
                             String query3 = "delete from books where isbn="+id;
                   ...
                   try (Statement statement = connection.createStatement()) 
                   {
                       ...
                       if(rs1.next()==false){
                           JOptionPane.showMessageDialog(null, "warning ID WRONG!", "Warning", JOptionPane.WARNING_MESSAGE);
                             ...
                             String query = "UPDATE books SET auteur = ?, titre = ?, quantity = ?, url = ? WHERE isbn = ?";
        ...
        jLabel12.addMouseListener(new MouseAdapter(){
                public void mouseClicked(MouseEvent evt){
                    ...
                    if(rech.equals("Search by Name of Book")==false && rech.equals("")==false){
                      query = "select * from books where titre='"+rech+"'";
                        }
                    else{
