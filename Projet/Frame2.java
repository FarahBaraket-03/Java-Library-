...
public  class Frame2 extends JFrame{
    // const par parametere
    public Frame2(String name_lib) throws IOException 
    {
        ...
        JLabel admin=createJLabel("Welcome "+name_lib);///varaiable nom
        panel_admin.add(logo);
        admin.setIcon(new ImageIcon(getClass().getResource("/Projet/design/male_user_50px.png")));
        logo.setIcon(new ImageIcon(getClass().getResource("/Projet/design/icons8_Library_32px.png")));
        panel_admin.add(admin);
        this.add(panel_admin);
        
        //----------------------------------------------------------------------------------------------
        Navbar panel_bar;
        panel_bar = new Navbar(this,name_lib);
        this.add(panel_bar);
